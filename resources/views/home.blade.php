...
<html lang="en">
  <head>
    ...
    <!-- /CSS Custom -->
    <title>Afrodita scorts</title>
    <!-- estilos transition-->
    <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
    <!--Estilos carrusel clientes-->
      ...
      <div class="row border">
        ...
        <div class="col-12">
          ...
          <div class="slider" style="background-image: url(Img/logo.jpg)" class="slider-img">
            <div><img class="slider-img" src="Img/img1.jpg" alt=""></div>
            <div><img class="slider-img" src="Img/img4.jpg"  alt=""></div>
            <div><img class="slider-img" src="Img/img6.jpg"  alt=""></div>
            <div><img class="slider-img" src="Img/img7.jpg"  alt=""></div>
            <div><img class="slider-img" src="Img/img11.jpg"  alt=""></div>
            <div><img class="slider-img" src="Img/img12.jpg"  alt=""></div>
            <div><img class="slider-img" src="Img/img11.jpg"  alt=""></div>
            <div><img class="slider-img" src="Img/img6.jpg"  alt=""></div>
          </div>
